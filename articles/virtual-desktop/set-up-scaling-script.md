...
- Max runtime of a job in the runbook is 3 hours.In case starting/stopping of VM's in a host pool takes longer than that, the job would fail.  More details : https://docs.microsoft.com/en-us/azure/automation/automation-runbook-execution#fair-share
...
Now that you have an Azure Automation account, you'll also need to create an Azure Automation Run As account if you don't have one for the tool to access your Azure resources. //Optional if you have an existing AzureRunAsAccount
